...
//			Request r = inviteRequest.buildMessage(this, to, message);
			...
			System.out.println("cyy:信息是:"+message);
	...
	public void processRequest(RequestEvent arg0) {
		...
		if (request.getMethod().equals("MESSAGE")) {
			...
			try {
				...
				System.out.println("收到request消息"+message);
				messageProcessor.processWhisperMessage("陈亦阳",message);

				dispatchSipEvent(new SipEvent(this, SipEvent.SipEventType.MESSAGE, message,
